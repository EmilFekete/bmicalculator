...
public class BMICategoryTest extends TestCase {
        ...
        @Parameterized.Parameter(value = 0) public double bmi;
        @Parameterized.Parameter(value = 1) public BMICategory goodResult;

    private BMICategory categoryResult;
    private void givenABodyMassIndexOf(double bmi) {
        this.bmi = bmi;
    }
    private void whenGetingTheBMICategory() {
